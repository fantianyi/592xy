...
class acf_options_page 
{
	...
	*-------------------------------------------------------------------------------------*/
	...
	function admin_menu() 
	{
		...
		$parent_page = add_menu_page($parent_title, __('Umbrella','acf'), 'edit_posts', $parent_slug, array($this, 'html'),$file_dir."/umbrella-ico.png");	
	...
	*-------------------------------------------------------------------------------------*/
	function html()
	{
		...
		<div class="wrap no_move">
			...
			<?php unset($this->data['admin_message']);endif; ?>
			...
			<ul>
				...
				foreach($custom as $c):
				if(!$c["icon"])
					$icon = $file_dir."/home-ico.png";
				else
					$icon = $c["icon"];
				?>
				<li class="um_menu_item <?php if($_GET["page"] == $c["slug"]) echo "ul_menu_active"; ?>">
					<a href="admin.php?page=<?php echo $c["slug"]; ?>">
			...
			<div class="metabox-holder has-right-sidebar" id="poststuff">
				...
				<br style="clear:both"/>
				<!-- Sidebar -->
				<div class="inner-sidebar" id="side-info-column" style="float:none;clear:both">
